...
function DashboardPage({ userName = '', user, onLogout, token, onUserRefresh }) {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f5f3ee] text-[#2e3643]">
      ...
      <div className="flex min-h-[calc(100vh-72px)]">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <main className="px-4 pb-8 pt-5 sm:px-6 lg:px-8">
            ...
            <section>
              <p className="text-[34px] font-semibold leading-none sm:text-[38px] lg:text-[44px]">Risk Analysis</p>
              <p className="mt-2 max-w-[560px] text-[14px] leading-[1.45] text-[#59616d] sm:text-[15px] lg:text-[16px]">
                This section will show live risk metrics once backend analytics data
                is connected.
              </p>
            </section>

            <section className="mt-5 grid gap-3 lg:gap-4 xl:grid-cols-2 2xl:grid-cols-[1.02fr_1fr_1.18fr]">
              <article className="rounded-3xl border border-[#e9e4da] bg-[#f8f6f1] p-5 lg:p-6">
                ...
                <div className="mx-auto mt-6 grid h-[180px] w-[180px] place-items-center rounded-full border-[10px] border-[#9c8b2e] sm:h-[210px] sm:w-[210px] lg:h-[230px] lg:w-[230px]">
                  <div className="text-center">
                    <p className="text-[48px] font-semibold leading-none sm:text-[54px] lg:text-[56px]">{safetyIndex}</p>
                    <p className="mt-1.5 text-[14px] font-semibold tracking-[0.06em] text-[#6f7682] sm:text-[16px]">
                      {riskLabel}
                    </p>
                  </div>
                </div>
                <p className="mt-6 text-[18px] font-medium sm:text-[20px] lg:text-[22px]">Current risk: {riskLabel}</p>
                <p className="mt-2 text-[14px] leading-[1.45] text-[#636b78] sm:text-[16px] lg:text-[17px]">
              ...
              <div className="space-y-3 lg:space-y-4">
                <article className="rounded-3xl border border-[#e6e3dc] bg-white p-5 lg:p-6">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="text-[36px] font-semibold leading-[0.95] sm:text-[42px] lg:text-[50px]">Expected Weekly</p>
                      <p className="mt-2 text-[14px] text-[#6d7480] sm:text-[16px] lg:text-[17px]">{weatherLine}</p>
                    </div>
                    <span className="rounded-full bg-[#dbe6f8] px-2.5 py-1 text-[11px] font-semibold text-[#3f4a59] sm:px-3 sm:text-[12px]">
                      AI LIVE
                    </span>
                  </div>
                  <p className="mt-4 text-[44px] font-semibold leading-none sm:text-[54px] lg:text-[62px]">
                    ₹{Number(pricing?.weeklyPrice || 0)}
                    <span className="ml-2 text-[20px] text-[#897821] sm:text-[24px] lg:text-[26px]">{riskLabel}</span>
                  </p>
                ...
                <article className="rounded-3xl border border-[#ece4cc] bg-[#f5ecd4] p-5 lg:p-6">
                  <p className="text-[34px] font-semibold leading-none sm:text-[40px] lg:text-[46px]">Volatility Shield</p>
                  <p className="mt-2 text-[14px] leading-[1.45] text-[#686f7a] sm:text-[15px] lg:text-[16px]">
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[17px] font-semibold sm:text-[18px]">Protection Status</p>
                      <p className="text-[13px] text-[#7a808a] sm:text-[14px]">
              ...
              <div className="space-y-3 lg:space-y-4">
                <article className="rounded-3xl bg-[#6f819b] p-5 text-white lg:p-6">
                  ...
                  <p className="mt-4 text-[40px] font-semibold leading-[0.95] sm:text-[48px] lg:text-[56px]">Suggested Coverage</p>
                  <p className="mt-3 text-[14px] leading-[1.45] text-[#e8edf5] sm:text-[16px] lg:text-[17px]">
                    Recommendation updates every time you open plan selection with latest forecast.
                  </p>
                  <p className="mt-5 text-[46px] font-semibold leading-none sm:text-[54px] lg:text-[62px]">
                    ₹{Number(pricing?.weeklyPrice || 0)} <span className="text-[20px] font-normal sm:text-[24px] lg:text-[26px]">/week</span>
                  </p>
                  <button
                    type="button"
                ...
                <article className="rounded-3xl border border-[#e6e1d7] bg-[#f6f3ec] p-5 lg:p-6">
                  <div className="flex items-center justify-between">
                    <p className="text-[34px] font-semibold leading-none sm:text-[42px] lg:text-[48px]">Premium Estimate</p>
                    <Info className="h-5 w-5 text-[#646c78]" />
                  </div>
                  <div className="mt-4 space-y-3 text-[15px] sm:text-[17px] lg:text-[18px]">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between border-t border-[#e5dfd3] pt-3">
                      <p className="text-[20px] font-semibold sm:text-[22px] lg:text-[24px]">Monthly Premium</p>
                      <p className="text-[30px] font-semibold text-[#8b7421] sm:text-[38px] lg:text-[42px]">
            ...
            <section className="mt-3 grid gap-3 lg:gap-4 lg:grid-cols-2">
              <article className="rounded-3xl border border-[#e7e3dc] bg-[#f7f5f0] p-5 lg:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[22px] font-semibold lg:text-[26px]">AI Intelligence Layer</p>
                    <p className="mt-1 text-[14px] leading-[1.45] text-[#646d79] lg:text-[16px]">
              ...
              <article className="rounded-3xl border border-[#e7e3dc] bg-[#f7f5f0] p-5 lg:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[22px] font-semibold lg:text-[26px]">Historical Correlation</p>
                    <p className="mt-1 text-[14px] leading-[1.45] text-[#646d79] lg:text-[16px]">
          ...
          <footer className="mt-auto border-t border-[#ebe8e2] px-4 py-5 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-4 text-[13px] text-[#676e79] xl:flex-row xl:items-center xl:justify-between">
              <div className="flex flex-wrap items-center gap-6">
                <p className="text-[24px] font-semibold text-[#3f4652] sm:text-[28px]">PayNest AI</p>
