...
function ActivitiesPage({ userName = '', user, token, onLogout, onUserRefresh }) {
  ...
  return (
    <div className="min-h-screen bg-[#f5f3ee] text-[#2b3340]">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <main className="px-5 pb-12 pt-8 sm:px-8">
            <section className="grid gap-5 xl:grid-cols-[1.9fr_0.9fr]">
              <article className="rounded-[30px] border border-[#ebe7de] bg-[#f7f5f0] p-6">
                <span className="rounded-full bg-[#dbe6f8] px-3 py-1 text-[12px] font-semibold text-[#425066]">
                  Protected
                </span>
                <h1 className="mt-4 text-[55px] font-semibold leading-[0.95]">Active Coverage Overview</h1>
                <p className="mt-3 max-w-[720px] text-[16px] leading-[1.45] text-[#626a77]">
                ...
                <div className="mt-6 grid gap-3 md:grid-cols-3">
                  <article className="rounded-2xl bg-white p-4">
                    ...
                    <p className="mt-2 text-[44px] font-semibold leading-none">₹{remainingCoverage.toFixed(2)}</p>
                    <div className="mt-4 h-1.5 rounded-full bg-[#e7e5e0]" />
                  </article>
                  <article className="rounded-2xl bg-white p-4">
                    <p className="text-[12px] uppercase tracking-[0.1em] text-[#7d8591]">Days Left</p>
                    <p className="mt-2 text-[42px] font-semibold leading-none">{daysLeft} Days</p>
                  ...
                  <article className="rounded-2xl bg-white p-4">
                    ...
                    <p className="mt-2 inline-flex items-center gap-2 text-[42px] font-semibold leading-none">
              ...
              <article className="rounded-[30px] bg-[#6f819b] p-6 text-white">
                <h2 className="text-[38px] font-semibold leading-none">Resilience Score</h2>
                <p className="mt-3 text-[15px] leading-[1.45] text-[#e8edf5]">
                  Score will update when backend metrics are available.
                </p>
                <div className="mx-auto mt-8 grid h-[170px] w-[170px] place-items-center rounded-full border-[10px] border-[#e1bf34]">
                  <div className="text-center">
                    <p className="text-[56px] font-semibold leading-none">0</p>
              ...
              <article className="rounded-3xl border border-[#e8e3da] bg-[#f7f5f0] p-5">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-[40px] font-semibold leading-none">{weatherStatus}</p>
                  </div>
                ...
                {weatherTemp === null ? (
                  <p className="mt-6 text-[56px] font-semibold leading-none">
                    0°C <span className="text-[22px] font-normal">H 0° L: 0°</span>
                  </p>
                ) : (
                  <p className="mt-6 text-[56px] font-semibold leading-none">
                    {weatherTemp}°C{' '}
              ...
              <article className="rounded-3xl border border-[#e8e3da] bg-[#f7f5f0] p-5">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-[40px] font-semibold leading-none">{airQualityLabel}</p>
                  </div>
                ...
                <p className="mt-6 text-[56px] font-semibold leading-none">
                  {aqi ?? 0}{' '}
                  <span className="text-[22px] font-semibold text-[#23a26f]">AQI</span>
                </p>
              ...
              <article className="rounded-3xl border border-[#e8e3da] bg-[#f7f5f0] p-5">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-[40px] font-semibold leading-none">Live map</p>
                  </div>
            ...
            <section className="mt-5 rounded-3xl border border-[#e8e3da] bg-[#f0ede7] px-6 py-5">
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[34px] font-semibold leading-none">Next Disbursement</p>
                    <p className="mt-1 text-[15px] text-[#666f7c]">{nextDisbursementLabel}</p>
                  </div>
                </div>
